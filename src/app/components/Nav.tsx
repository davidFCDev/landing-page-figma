...
const Nav = () => {
  return (
    <div className="w-full flex items-center justify-between px-6 lg:px-20 py-3 sm:py-5 font-semibold font-rubik text-lg">
      ...
      <button className="inline-flex justify-center items-center bg-orange text-white px-4 py-2 lg:py-4 rounded-2xl hover:bg-orange2">
        Sign Up
      </button>
    </div>
  );
