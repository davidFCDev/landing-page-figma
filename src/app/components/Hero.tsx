      ...
      <div className="flex flex-column justify-center items-end text-center pt-36">
        <div className="w-[52%] flex flex-col gap-10 z-20 relative top-8">
          ...
          <div className="z-50 relative">
            <button className="bg-yellow inline-flex px-6 py-4 justify-center items-center border-3 border-black rounded-full text-black text-4xl font-bold shadow-[-6px_7px_0_0_black] active:shadow-none transition-all active:-translate-x-1 active:translate-y-1">
              Explore
            </button>
          </div>
        </div>
