...
const Logos = () => {
  return (
    <div className="flex w-full z-0 relative justify-start items-center py-5 ">
      ...
      <div className="z-20 absolute flex flex-col gap-10 sm:gap-24 lg:gap-32">
        <div className="text-white px-8 sm:px-20 flex items-start w-full relative">
          <div className="flex flex-col gap-2 sm:gap-5 w-[350px] lg:w-[700px]">
            <h4 className="text-xs lg:text-xl uppercase font-rubik font-semibold tracking-[0.3em]">
              Partners
            </h4>
            <h2 className="text-3xl lg:text-7xl font-semibold font-averia leading-[1.2em]">
          ...
          <img
            src="/arrow.png"
            alt="arrow"
            className="z-50 left-[55%] lg:left-[45%] -bottom-[30%] sm:-bottom-[40%] absolute w-[70px] sm:w-[150px] lg:w-[300px]"
          />
        </div>
