  ...
  return (
    <div className="w-full flex">
      <img
        src="/texture-bg.png"
        alt="bg-texture"
        className="w-full bg-green z-0 rounded-b-[40px] sm:rounded-b-[200px] relative h-[1080px] sm:h-[1000px]"
      />
      <img
        src="/horizontal-arrow.png"
        alt="arrow"
        className="absolute z-70 left-8 sm:left-48 pt-40 sm:pt-28 w-[80px] sm:w-[300px]"
      />
      ...
      <div className="z-30 absolute flex flex-col w-full justify-center items-center gap-16 sm:gap-24 pt-44 sm:pt-52">
        ...
        <motion.div
          ...
          ref={ref}
          className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-10 font-averia"
        >
          <div className="flex items-start gap-3 sm:gap-4 w-[350px] sm:w-[500px] py-5 sm:py-8 px-8 sm:px-10 bg-green2 rounded-2xl">
            <img
            ...
            <div className="flex flex-col gap-1 sm:gap-4">
              ...
              <p className="text-[14px] sm:text-[16px] text-gray2 tracking-wide">
